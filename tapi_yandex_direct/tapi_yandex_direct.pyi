...
class YandexDirectClientResponse(YandexDirectBaseMethodsClientResponse):
    ...
    ) -> Generator["YandexDirectPageIteratorExecutor"]: ...
    def items(self, max_items: Optional[int] = None) -> Generator[dict]: ...
    def iter_items(
        self, max_pages: Optional[int] = None, max_items: Optional[int] = None
    ) -> Generator[dict]: ...
...
class YandexDirectClientReportResponse(YandexDirectBaseMethodsClientResponse):
    ...
    def iter_values(self) -> Generator[tuple]: ...
    def iter_dicts(self) -> Generator[dict]: ...
